...
export default function AdminDashboard() {
  ...
  if (authLoading || goalsLoading || cycleLoading) {
    return (
      <div className="md:ml-64 pt-16 min-h-screen w-full flex items-center justify-center bg-background">
  ...
  return (
    <main className="pt-16 md:pl-64 p-4 md:p-8 min-h-screen w-full flex-grow">
